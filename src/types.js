/**
 * These types have been copied from the @types/react-beautiful-dnd package
 * and modified to reflect the changes made in this fork of react-beautiful-dnd.
 */
...
export interface DroppableProps {
  ...
  /**
   * If provided, then this Droppable's Draggable children will scroll this element
   * while dragging rather than the closest scrollable parent.
   */

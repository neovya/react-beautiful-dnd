(function (global, factory) {
  ...
  */
  ...
  var getEnv = (function (start, scrollContainer) {
    var closestScrollable = scrollContainer != null ? scrollContainer : getClosestScrollable(start);
  ...
  function useDroppablePublisher(args) {
    ...
    var getDimensionAndWatchScroll = useCallback(function (windowScroll, options) {
      ...
      var env = getEnv(ref, previous.scrollContainer);
      var dragging = {
        ref: ref,
        descriptor: descriptor,
        env: env,
